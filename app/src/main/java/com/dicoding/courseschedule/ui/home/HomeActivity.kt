...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getNearestSchedule(queryType).observe(this) {
            ...
            Log.d("Wisnu Home", "IT: $it")
        }

        Log.d("Wisnu Home", "onCreate: $queryType")
        Log.d("Wisnu Home", "onCreate: ${viewModel.getNearestSchedule(queryType)}")
    }
    ...
    private fun showTodaySchedule(course: Course?) {
        ...
        course?.apply {
            ...
            Log.d("Wisnu Home", "Course Name: $courseName")
            Log.d("Wisnu Home", "Time: $time")
            Log.d("Wisnu Home", "Remaining Time: $remainingTime")
            Log.d("Wisnu Home", "Lecturer: $lecturer")
        }
        Log.d("Wisnu Home", "showTodaySchedule: $course")
